...
| T-07 | Credentials leak into code, logs, prompts or exports | KeyStore protocol + safe filenames; prompt redaction; structured logs carry no secrets | key-store traversal/dir-refusal tests in `tests/test_ops.py`; `tests/test_ai_redact.py` |
